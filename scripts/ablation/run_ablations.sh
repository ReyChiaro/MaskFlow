...
run_base_experiment() {
    ...
    local base_args=(
        ...
        "pipeline.enable_mask_denoise_train=false"
        "pipeline.enable_mask_denoise_infer=false"
        "pipeline.enable_pixel_blend=false"
        "pipeline.enable_poisson_train=false"
        "pipeline.enable_poisson_infer=false"
        "pipeline.poisson_steps=[0,1.0]"
        "pipeline.poisson_in_color=0.1"
        "pipeline.poisson_out_color=0.1"
        "pipeline.num_iter=20"
        "pipeline.momentum=0.1"
